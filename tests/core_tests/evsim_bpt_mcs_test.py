...
runs on `config-sil-dc-d20.yaml` with the BPT services enabled, which declares no connector
...
@pytest.mark.everest_config_adaptions(EvSimulatorConfigAdjustment(
    overrides=EVSIM_DC_SESSION,
    charger_overrides={"supported_d20_energy_services": "DC_BPT,DC"}))
