...
class DcConfigAdjustmentStrategy(EverestConfigAdjustmentStrategy):
    ...
    def __init__(self, zero_power_ignore_pause: bool = False, hlc_charge_loop_without_energy_timeout_s: int = 300, ev_d20_only = False, payment_enable_contract = True, force_payment_option = False, fail_cable_check=False, cable_check_measurements: int = 1, protocol_mismatch=False, secc_iso20_disabled_mismatch=False):
