...
class ConfigServiceClientIfc {
public:
    virtual ~ConfigServiceClientIfc() = default;
    ...
    virtual std::optional<SetDescriptionResult> set_description(int slot_id, const std::string& description) = 0;
    virtual std::optional<GetConfigurationResult> get_configuration(int slot_id, bool force_read_from_db) = 0;
    ...
    virtual std::optional<GetConfigurationParameterResult>
    get_config_parameters(const GetConfigurationParameterRequest& request) = 0;
