...
class MqttConfigServiceClient : public ConfigServiceClientIfc {
public:
    ...
    std::optional<SetDescriptionResult> set_description(int slot_id, const std::string& description) override;
    std::optional<GetConfigurationResult> get_configuration(int slot_id, bool force_read_from_db) override;
    ...
    std::optional<GetConfigurationParameterResult>
    get_config_parameters(const GetConfigurationParameterRequest& request) override;
