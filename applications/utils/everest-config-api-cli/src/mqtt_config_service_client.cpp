...
std::optional<API_types_cfg::GetConfigurationResult>
MqttConfigServiceClient::get_configuration(int slot_id, bool force_read_from_db) {
...
MqttConfigServiceClient::get_config_parameters(const API_types_cfg::GetConfigurationParameterRequest& request) {
    return perform_rpc<API_types_cfg::GetConfigurationParameterRequest, API_types_cfg::GetConfigurationParameterResult>(
        "get_config_parameters", request);
}
