...
MqttConfigServiceClient::duplicate_slot(int slot_id, const std::string& description) {
    ...
    return perform_rpc<API_types_cfg::DuplicateSlotRequest, API_types_cfg::DuplicateSlotResult>("duplicate_slot", req);
}

std::optional<API_types_cfg::LoadFromYamlResult> MqttConfigServiceClient::load_from_yaml(const std::string& raw_yaml,
...
std::optional<SetDescriptionResult> MqttConfigServiceClient::set_description(int slot_id,
                                                                             const std::string& description) {
    API_types_cfg::SetDescriptionRequest req;
    req.slot_id = slot_id;
    req.description = description;
    return perform_rpc<API_types_cfg::SetDescriptionRequest, API_types_cfg::SetDescriptionResult>("set_description",
                                                                                                  req);
}

std::optional<API_types_cfg::GetConfigurationResult> MqttConfigServiceClient::get_configuration(int slot_id, bool force_read_from_db) {
    API_types_cfg::GetConfigurationRequest req;
    req.slot_id = slot_id;
    req.force_read_from_db = force_read_from_db;
...
std::optional<API_types_cfg::GetConfigurationParameterResult>
MqttConfigServiceClient::get_config_parameters(const API_types_cfg::GetConfigurationParameterRequest& request) {
    return perform_rpc<API_types_cfg::GetConfigurationParameterRequest,
                       API_types_cfg::GetConfigurationParameterResult>("get_config_parameters", request);
}
