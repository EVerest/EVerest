...
from .configuration_api import ConfigurationApiClient
from .lifecycle_api import LifecycleApiClient, default_broker, make_mqtt_client
from .mqtt_rpc import NoticeListener
...
class Session:
    ...
    def __init__(self, host: Optional[str] = None, port: Optional[int] = None, timeout_s: float = 10.0,
                 client_id: Optional[str] = None, verbose: bool = False):
        self.host, self.port = default_broker(host, port)
