...
usage() {
    ...
    echo -e "\t--repo: Git repository - Optional, defaults to: https://github.com/EVerest/EVerest.git"
    ...
    echo -e "\t--name: Name of the docker image - Optional, defaults to: everest"
...
if [ -z "${repo}" ]; then
    repo="https://github.com/EVerest/EVerest.git"
fi
