...
TEST(test_iso2_session_setup_req_round_trip) {
    ...
    cJSON* orig_body =
        cJSON_GetObjectItemCaseSensitive(cJSON_GetObjectItemCaseSensitive(original, "V2G_Message"), "Body");
    cJSON* round_body =
        cJSON_GetObjectItemCaseSensitive(cJSON_GetObjectItemCaseSensitive(round, "V2G_Message"), "Body");
...
TEST(test_iso2_charging_status_round_trip) {
    ...
    cJSON* res = cJSON_GetObjectItemCaseSensitive(
        cJSON_GetObjectItemCaseSensitive(cJSON_GetObjectItemCaseSensitive(round2, "V2G_Message"), "Body"),
        "ChargingStatusRes");
    EXPECT(res != NULL);
