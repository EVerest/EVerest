...
# machine running it. That matters: where /bin/sh is bash a shelled-out
# `echo -e` looks correct, and the breakage appears only where /bin/sh is
# dash, which is the default on Debian and Ubuntu derivatives.
#
