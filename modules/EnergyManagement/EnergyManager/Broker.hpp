...
protected:
    ...
    bool buy_ampere_import(int index, double ampere, bool allow_less, types::energy::IntegerWithSource number_of_phases);
    bool buy_ampere_export(int index, double ampere, bool allow_less, types::energy::IntegerWithSource number_of_phases);
    bool buy_ampere(const types::energy::ScheduleReqEntry& _offer, int index, double ampere, bool allow_less,
                    bool import, types::energy::IntegerWithSource number_of_phases);

    bool buy_watt_import(int index, double watt, bool allow_less);
    bool buy_watt_export(int index, double watt, bool allow_less);
    bool buy_watt(const types::energy::ScheduleReqEntry& _offer, int index, double watt, bool allow_less, bool import);
