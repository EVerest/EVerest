...
function(_target_includes_check)
    ...
    if (NOT arg_TARGET)
        message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION} TARGET not set")
    endif()
    if (NOT TARGET ${arg_TARGET})
        message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION} TARGET ${arg_TARGET} not found")
    endif()
    if (NOT arg_INCLUDES)
        message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION} INCLUDES not set")
    endif()
...
macro(sanity_checks)
    ...
    message(STATUS "Sanity checks for including generated files passed ✅")
endmacro()
