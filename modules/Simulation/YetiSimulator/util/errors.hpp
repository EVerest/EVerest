...
/// Looks up an ErrorDefinition by its full type string (e.g. "evse_board_support/MREC6UnderVoltage").
/// Returns nullopt when no matching entry is found.
...
inline const auto connector_lock_ConnectorLockUnexpectedClose =
    ErrorDefinition{"connector_lock/ConnectorLockUnexpectedClose", "", "Simulated fault event",
                    Everest::error::Severity::High, ErrorTarget::ConnectorLock};

inline const auto evse_board_support_DiodeFault =
    ErrorDefinition{"evse_board_support/DiodeFault", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto evse_board_support_BrownOut =
    ErrorDefinition{"evse_board_support/BrownOut", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto evse_board_support_EnergyManagement =
    ErrorDefinition{"evse_board_support/EnergyManagement", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto evse_board_support_PermanentFault =
    ErrorDefinition{"evse_board_support/PermanentFault", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};
...
inline const auto evse_board_support_MREC2GroundFailure =
    ErrorDefinition{"evse_board_support/MREC2GroundFailure", "", "Simulated fault event",
                    Everest::error::Severity::High, ErrorTarget::BoardSupport};
...
inline const auto evse_board_support_MREC5OverVoltage =
    ErrorDefinition{"evse_board_support/MREC5OverVoltage", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto evse_board_support_MREC6UnderVoltage =
    ErrorDefinition{"evse_board_support/MREC6UnderVoltage", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};
...
inline const auto evse_board_support_MREC14PilotFault =
    ErrorDefinition{"evse_board_support/MREC14PilotFault", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto evse_board_support_MREC15PowerLoss =
    ErrorDefinition{"evse_board_support/MREC15PowerLoss", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};
...
inline const auto evse_board_support_MREC25BrokenLatch =
    ErrorDefinition{"evse_board_support/MREC25BrokenLatch", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto evse_board_support_MREC26CutCable =
    ErrorDefinition{"evse_board_support/MREC26CutCable", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto evse_board_support_TiltDetected =
    ErrorDefinition{"evse_board_support/TiltDetected", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};
...
inline const auto evse_board_support_EnclosureOpen =
    ErrorDefinition{"evse_board_support/EnclosureOpen", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::BoardSupport};

inline const auto ac_rcd_VendorError = ErrorDefinition{"ac_rcd/VendorError", "", "Simulated fault event",
                                                       Everest::error::Severity::High, ErrorTarget::Rcd};

inline const auto ac_rcd_Selftest =
    ErrorDefinition{"ac_rcd/Selftest", "", "Simulated fault event", Everest::error::Severity::High, ErrorTarget::Rcd};

inline const auto ac_rcd_AC =
    ErrorDefinition{"ac_rcd/AC", "", "Simulated fault event", Everest::error::Severity::High, ErrorTarget::Rcd};

inline const auto ac_rcd_DC =
    ErrorDefinition{"ac_rcd/DC", "", "Simulated fault event", Everest::error::Severity::High, ErrorTarget::Rcd};
...
inline const auto connector_lock_VendorError =
    ErrorDefinition{"connector_lock/VendorError", "", "Simulated fault event", Everest::error::Severity::High,
                    ErrorTarget::ConnectorLock};
