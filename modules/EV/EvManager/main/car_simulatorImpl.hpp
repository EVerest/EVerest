...
private:
    ...
    // Tear the V2G session down at once, without a SessionStop exchange ([V2G2-025], [V2G2-728]).
    void abort_v2g_session();
    // Push the applied CP state to the HLC stack, which has no board support connection.
