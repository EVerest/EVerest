...
// or the other. EvSimRuntime is not unit-constructible without a live framework
// EvSimulator&, so epoll registration, fd flush and exception isolation stay in the
// SIL smokes.
