...
struct KindVisitor {
    ...
    EventKind operator()(const V2gMessagePayload&) const {
        return EventKind::V2gMessage;
    }
...
EventPayload default_payload_for(EventKind kind) {
    ...
    case EventKind::V2gMessage:
        return V2gMessagePayload{};
...
std::optional<API_types::ev_simulator::IsoSessionEventKind> iso_session_event_kind(EventKind kind) {
    using ISEK = API_types::ev_simulator::IsoSessionEventKind;
    switch (kind) {
    case EventKind::IsoPowerReady:
        return ISEK::PowerReady;
    case EventKind::IsoDcPowerOn:
        return ISEK::DcPowerOn;
    case EventKind::IsoStopFromCharger:
        return ISEK::StopFromCharger;
    case EventKind::IsoPauseFromCharger:
        return ISEK::PauseFromCharger;
    case EventKind::IsoV2GFinished:
        return ISEK::V2GFinished;
    default:
        return std::nullopt;
    }
}
