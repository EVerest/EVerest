...
struct RwConfUpdate {
    ...
    // e.g.
    // ConfigChangeResult on_log_interval_changed(const int& value) override {
...
public:
    ...
    // guards config/rw_config/original_config: the on_xxx_changed handlers are
    // invoked from a different thread than the module code
