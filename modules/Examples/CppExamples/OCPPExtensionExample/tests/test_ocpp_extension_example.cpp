...
TEST_F(OCPPExtensionTest, UpdateKeys) {
    ...
    EXPECT_EQ(
        log[0].msg,
        R"({"data":{"response":{"status":"Accepted","status_info":""},"status":"Ok","status_info":"","type":"Set"},"msg_type":"ConfigurationResponse"})");
...
TEST_F(OCPPExtensionTest, RebootRequired) {
    ...
    EXPECT_EQ(
        log[0].msg,
        R"({"data":{"response":{"status":"RebootRequired","status_info":""},"status":"Ok","status_info":"","type":"Set"},"msg_type":"ConfigurationResponse"})");
}
...
TEST_F(OCPPExtensionTest, Rejected) {
    ...
    EXPECT_EQ(
        log[0].msg,
        R"({"data":{"response":{"status":"Rejected","status_info":""},"status":"Ok","status_info":"handler not implemented","type":"Set"},"msg_type":"ConfigurationResponse"})");
}
