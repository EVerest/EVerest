...
#ifndef EASTRON_SDM630EV_HPP
#define EASTRON_SDM630EV_HPP
...
class Eastron_SDM630EV : public Everest::ModuleBase {
public:
    Eastron_SDM630EV() = delete;
    Eastron_SDM630EV(const ModuleInfo& info, std::unique_ptr<powermeterImplBase> p_main,
