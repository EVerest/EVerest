...
EvseSlac is the charger-side (EVSE) implementation of the SLAC protocol
...
EvseSlac is driven by the EvseManager module: when the car is plugged in
...
::
   ...
   Car plugged in (CP state A -> B)
          |
          v
   EvseManager: enter_bcd  ------------>  EvseSlac armed
          |
          v
...
asks the charger how many toggles it saw. EvseSlac implements the full
...
queries of multiple EvseSlac instances at boot.
...
* The EV-side counterpart of this module is **EvSlac**, built on the
