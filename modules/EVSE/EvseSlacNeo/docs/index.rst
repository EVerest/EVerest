...
NMK generation can also be configured:

- legacy_printable: default compatibility mode using legacy printable characters only (0-9A-Z).
- full_byte_range: explicit opt-in for the full NMK byte range (0x00..0xFF) to reduce collision probability.
