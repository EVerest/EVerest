...
#ifndef OCPP16_OCPP_1_6_CHARGE_POINT_IMPL_HPP
#define OCPP16_OCPP_1_6_CHARGE_POINT_IMPL_HPP
...
public:
    ...
    ocpp_1_6_charge_pointImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<OCPPmulti>& mod, Conf& config) :
        ocpp_1_6_charge_pointImplBase(ev, "ocpp16"), mod(mod), config(config){};
...
private:
    const Everest::PtrContainer<OCPPmulti>& mod;
    const Conf& config;
...
#endif // OCPP16_OCPP_1_6_CHARGE_POINT_IMPL_HPP
