...
#ifndef OCPP_DEBUG_CONSUMER_API_HPP
#define OCPP_DEBUG_CONSUMER_API_HPP
...
class ocpp_debug_consumer_API : public Everest::ModuleBase {
public:
    ocpp_debug_consumer_API() = delete;
    ocpp_debug_consumer_API(const ModuleInfo& info, Everest::MqttProvider& mqtt_provider,
                            std::unique_ptr<generic_errorImplBase> p_generic_error,
                            std::unique_ptr<ocpp_debugIntf> r_ocpp_debug, Conf& config) :
        ModuleBase(info),
        mqtt(mqtt_provider),
...
#endif // OCPP_DEBUG_CONSUMER_API_HPP
