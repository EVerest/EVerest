...
public:
    ...
    generic_errorImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<ocpp_debug_consumer_API>& mod,
                      Conf& config) :
...
private:
    const Everest::PtrContainer<ocpp_debug_consumer_API>& mod;
    const Conf& config;
