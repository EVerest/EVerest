...
public:
    ...
    generic_errorImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<session_storage_consumer_API>& mod,
                      Conf& config) :
...
private:
    const Everest::PtrContainer<session_storage_consumer_API>& mod;
    const Conf& config;
