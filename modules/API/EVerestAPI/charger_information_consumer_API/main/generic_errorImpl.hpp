...
public:
    ...
    generic_errorImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<charger_information_consumer_API>& mod,
                      Conf& config) :
...
private:
    const Everest::PtrContainer<charger_information_consumer_API>& mod;
    const Conf& config;
