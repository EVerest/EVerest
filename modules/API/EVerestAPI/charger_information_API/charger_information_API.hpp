...
#ifndef CHARGER_INFORMATION_API_HPP
#define CHARGER_INFORMATION_API_HPP
...
class charger_information_API : public Everest::ModuleBase {
public:
    charger_information_API() = delete;
    charger_information_API(const ModuleInfo& info, Everest::MqttProvider& mqtt_provider,
                            std::unique_ptr<charger_informationImplBase> p_main,
    ...
    ev_API::ApiHelper helper{info, mqtt_v, {{"charger_information", 1}}, get_config_service_client()};
    // ev@1fce4c5e-0ab8-41bb-90f7-14277703d2ac:v1
...
#endif // CHARGER_INFORMATION_API_HPP
