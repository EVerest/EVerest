...
public:
    ...
    charger_informationImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<charger_information_API>& mod,
                            Conf& config) :
...
private:
    const Everest::PtrContainer<charger_information_API>& mod;
    const Conf& config;
