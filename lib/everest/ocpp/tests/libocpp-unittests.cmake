...
set(FULL_CONFIG_FILE_LOCATION_V16 ${CMAKE_CURRENT_SOURCE_DIR}/config/v16/resources/config-full.json)
...
set(TEST_COMPILE_DEFINITIONS
    ...
    FULL_CONFIG_FILE_LOCATION_V16="${FULL_CONFIG_FILE_LOCATION_V16}"
...
set(LIBOCPP_TEST_INCLUDE_V2_SOURCES ${LIBOCPP_LIB_PATH}/ocpp/v16/ocpp_enums.cpp   # This is currently still needed but might be removed in the future.
                                      ...
                                      ${OCPP16_LEGACY_CTRLR_DEFAULT_SCHEMA_GENERATED}
                                      ${LIBOCPP_LIB_PATH}/ocpp/v16/charge_point_configuration.cpp
                                      ${LIBOCPP_LIB_PATH}/ocpp/v16/ocpp_types.cpp
                                      ${LIBOCPP_LIB_PATH}/ocpp/v16/types.cpp
                                      ${LIBOCPP_LIB_PATH}/ocpp/common/schemas.cpp
)
