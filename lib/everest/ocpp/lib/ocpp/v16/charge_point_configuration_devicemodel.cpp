...
void ChargePointConfigurationDeviceModel::set_network_configuration_priority(const std::string& priority,
...
bool ChargePointConfigurationDeviceModel::write_network_connection_profile(
...
void ChargePointConfigurationDeviceModel::clear_network_connection_profile(int32_t /*slot*/) {
    EVLOG_warning << "OCPP 1.6 does not support multiple network connection profiles, ignoring clear request";
}

bool ChargePointConfigurationDeviceModel::get_allow_security_level_zero_connections() {
...
void ChargePointConfigurationDeviceModel::set_active_network_profile_slot(int32_t slot,
                                                                          const std::string& /*source*/) {
    EVLOG_warning << "OCPP 1.6 does not support multiple network connection profiles, ignoring set active slot " << slot;
}

void ChargePointConfigurationDeviceModel::set_per_slot_ocpp_version(int32_t /*slot*/, const std::string& /*version*/,
                                                                    const std::string& /*source*/) {
...
void ChargePointConfigurationDeviceModel::set_security_ctrl_identity(const std::string& /*identity*/,
                                                                     const std::string& /*source*/) {
