...
void ChargePointConfiguration::set_network_configuration_priority(const std::string& priority,
...
ChargePointConfiguration::read_network_connection_profile(int32_t slot) {
    if (slot != 1) {
        return std::nullopt;
    }
    ...
    profile.ocppInterface = ocpp::v2::OCPPInterfaceEnum::Any;
...
bool ChargePointConfiguration::write_network_connection_profile(int32_t slot,
...
void ChargePointConfiguration::clear_network_connection_profile(int32_t /*slot*/) {
    EVLOG_warning << "OCPP 1.6 does not support multiple network connection profiles, ignoring clear request";
}

bool ChargePointConfiguration::get_allow_security_level_zero_connections() {
...
std::optional<int32_t> ChargePointConfiguration::get_network_config_timeout() {
    return std::nullopt; // ConnectivityManager will apply its built-in 60 s default
}

std::optional<WebsocketConnectionOptions> ChargePointConfiguration::get_websocket_connection_options(int32_t /*slot*/) {
...
void ChargePointConfiguration::set_active_security_profile(int32_t security_profile,
                                                            const std::string& /*source*/) {
    setSecurityProfile(security_profile);
}

void ChargePointConfiguration::set_active_network_profile_slot(int32_t slot, const std::string& /*source*/) {
    EVLOG_warning << "OCPP 1.6 does not support multiple network connection profiles, ignoring set active slot " << slot;
}

void ChargePointConfiguration::set_per_slot_ocpp_version(int32_t /*slot*/, const std::string& /*version*/,
                                                          const std::string& /*source*/) {
    EVLOG_warning << "OCPP 1.6 does not support multiple network connection profiles, ignoring set OCPP version for slot";
}

void ChargePointConfiguration::set_security_ctrl_security_profile(int32_t security_profile,
                                                                    const std::string& /*source*/) {
    setSecurityProfile(security_profile);
}

void ChargePointConfiguration::set_security_ctrl_identity(const std::string& /*identity*/,
                                                           const std::string& /*source*/) {
