...
protected: // Members
    ...
    /// the adaptive timer. Declared last so it destructs first: its timer joins the io_context
    /// thread before the rest of SmartCharging tears down.
    DynamicScheduleManager dynamic_schedule_manager;
