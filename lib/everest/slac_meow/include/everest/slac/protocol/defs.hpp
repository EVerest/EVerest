...
inline constexpr std::uint16_t MMTYPE_CM_SET_KEY_REQ = MMTYPE_CM_SET_KEY | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_CM_SET_KEY_CNF = MMTYPE_CM_SET_KEY | MMTYPE_MODE_CNF;

inline constexpr std::uint16_t MMTYPE_CM_SLAC_PARAM = 0x6064;
inline constexpr std::uint16_t MMTYPE_CM_SLAC_PARAM_REQ = MMTYPE_CM_SLAC_PARAM | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_CM_SLAC_PARAM_CNF = MMTYPE_CM_SLAC_PARAM | MMTYPE_MODE_CNF;

inline constexpr std::uint16_t MMTYPE_CM_START_ATTEN_CHAR = 0x6068;
inline constexpr std::uint16_t MMTYPE_CM_START_ATTEN_CHAR_IND = MMTYPE_CM_START_ATTEN_CHAR | MMTYPE_MODE_IND;

inline constexpr std::uint16_t MMTYPE_CM_ATTEN_CHAR = 0x606C;
inline constexpr std::uint16_t MMTYPE_CM_ATTEN_CHAR_IND = MMTYPE_CM_ATTEN_CHAR | MMTYPE_MODE_IND;
inline constexpr std::uint16_t MMTYPE_CM_ATTEN_CHAR_RSP = MMTYPE_CM_ATTEN_CHAR | MMTYPE_MODE_RSP;

inline constexpr std::uint16_t MMTYPE_CM_MNBC_SOUND = 0x6074;
inline constexpr std::uint16_t MMTYPE_CM_MNBC_SOUND_IND = MMTYPE_CM_MNBC_SOUND | MMTYPE_MODE_IND;

inline constexpr std::uint16_t MMTYPE_CM_VALIDATE = 0x6078;
inline constexpr std::uint16_t MMTYPE_CM_VALIDATE_REQ = MMTYPE_CM_VALIDATE | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_CM_VALIDATE_CNF = MMTYPE_CM_VALIDATE | MMTYPE_MODE_CNF;

inline constexpr std::uint16_t MMTYPE_CM_SLAC_MATCH = 0x607C;
inline constexpr std::uint16_t MMTYPE_CM_SLAC_MATCH_REQ = MMTYPE_CM_SLAC_MATCH | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_CM_SLAC_MATCH_CNF = MMTYPE_CM_SLAC_MATCH | MMTYPE_MODE_CNF;
...
inline constexpr std::uint16_t MMTYPE_CM_RESET_DEVICE_REQ = MMTYPE_CM_RESET_DEVICE | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_CM_RESET_DEVICE_CNF = MMTYPE_CM_RESET_DEVICE | MMTYPE_MODE_CNF;

inline constexpr std::uint16_t MMTYPE_LINK_STATUS = 0xA0B8;
inline constexpr std::uint16_t MMTYPE_LINK_STATUS_REQ = MMTYPE_LINK_STATUS | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_LINK_STATUS_CNF = MMTYPE_LINK_STATUS | MMTYPE_MODE_CNF;

inline constexpr std::uint16_t MMTYPE_OP_ATTR = 0xA068;
inline constexpr std::uint16_t MMTYPE_OP_ATTR_REQ = MMTYPE_OP_ATTR | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_OP_ATTR_CNF = MMTYPE_OP_ATTR | MMTYPE_MODE_CNF;
...
inline constexpr std::uint16_t MMTYPE_NSCM_RESET_DEVICE_REQ = MMTYPE_NSCM_RESET_DEVICE | MMTYPE_MODE_REQ;

inline constexpr std::uint16_t MMTYPE_NSCM_GET_VERSION = 0xAC6C;
inline constexpr std::uint16_t MMTYPE_NSCM_GET_VERSION_REQ = MMTYPE_NSCM_GET_VERSION | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_NSCM_GET_VERSION_CNF = MMTYPE_NSCM_GET_VERSION | MMTYPE_MODE_CNF;

inline constexpr std::uint16_t MMTYPE_NSCM_GET_D_LINK_STATUS = 0xAC9C;
inline constexpr std::uint16_t MMTYPE_NSCM_GET_D_LINK_STATUS_REQ = MMTYPE_NSCM_GET_D_LINK_STATUS | MMTYPE_MODE_REQ;
inline constexpr std::uint16_t MMTYPE_NSCM_GET_D_LINK_STATUS_CNF = MMTYPE_NSCM_GET_D_LINK_STATUS | MMTYPE_MODE_CNF;
} // namespace lumissil
