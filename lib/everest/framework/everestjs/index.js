...
const EverestModule = function EverestModule(handler_setup, user_settings) {
  const env_settings = {
    ...
    framework_transport: process.env.EV_FRAMEWORK_TRANSPORT,
    shm_control_socket_path: process.env.EV_SHM_CONTROL_SOCKET_PATH,
    shm_registered_topics: process.env.EV_SHM_REGISTERED_TOPICS,
  ...
  const config = {
    ...
    framework_transport: helpers.get_default(settings, 'framework_transport', ''),
    shm_control_socket_path: helpers.get_default(settings, 'shm_control_socket_path', ''),
    shm_registered_topics: helpers.get_default(settings, 'shm_registered_topics', ''),
