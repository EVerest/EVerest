...
struct Matched_def : public state_machine_def<Matched_def> {
    ...
    struct transition_table : boost::mpl::vector<
        ...
        //    +----------+---------+----------+-----------------------+--------------------------------+
        Row   < Lumissil , update  , none     , service_matched_tick  , matched_tick_due               >,
        Row   < Lumissil , message , Failed   , none                  , link_lost                      >,
        Row   < Lumissil , message , none     , count_link_status_neg , link_flap                      >,
        Row   < Lumissil , message , none     , clear_link_status_neg , link_status_cnf                >,
        Row   < Lumissil , message , none     , send_amp_map_cnf      , is_amp_map_req                 >,
        Row   < Lumissil , message , none     , amp_map_cnf_ack       , is_amp_map_cnf_ok              >,
        //    +----------+---------+----------+-----------------------+--------------------------------+
        Row   < Qualcomm , update  , none     , service_matched_tick  , matched_tick_due               >,
        Row   < Qualcomm , message , Failed   , none                  , link_lost                      >,
        Row   < Qualcomm , message , none     , count_link_status_neg , link_flap                      >,
        Row   < Qualcomm , message , none     , clear_link_status_neg , link_status_cnf                >,
        Row   < Qualcomm , message , none     , send_amp_map_cnf      , is_amp_map_req                 >,
        Row   < Qualcomm , message , none     , amp_map_cnf_ack       , is_amp_map_cnf_ok              >,
        //    +----------+---------+----------+-----------------------+--------------------------------+
        Row   < NoDetect , message , none     , send_amp_map_cnf      , is_amp_map_req                 >,
        Row   < NoDetect , update  , none     , retransmit_amp_map    , amp_map_retransmit_due         >,
        Row   < NoDetect , message , none     , amp_map_cnf_ack       , is_amp_map_cnf_ok              >,
        Row   < Other    , message , none     , send_amp_map_cnf      , is_amp_map_req                 >,
        Row   < Init     , message , none     , send_amp_map_cnf      , is_amp_map_req                 >
        //    +----------+---------+----------+-----------------------+--------------------------------+
        >{};
    // clang-format on
