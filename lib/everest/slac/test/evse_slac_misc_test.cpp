...
bool test_accepts_set_key_cnf_success_result_per_mode() {
    ...
    ok &= assert_true(not accepts_set_key_cnf_success_result(SetKeyCnfSuccessMode::modem_compat_0x01, 0x00), test_name,
                      "modem_compat_0x01 must reject 0x00");
    ...
    ok &= assert_true(not accepts_set_key_cnf_success_result(SetKeyCnfSuccessMode::hpgp_standard_0x00, 0x01), test_name,
                      "hpgp_standard_0x00 must reject 0x01");
