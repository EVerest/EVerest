...
add_library(cbv2g_din STATIC IMPORTED)
add_library(cbv2g::din ALIAS cbv2g_din)
set_property(TARGET cbv2g_din PROPERTY IMPORTED_LOCATION ${CBV2G_LIB_DIR}/libcbv2g_din.a)
set_property(TARGET cbv2g_din PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CBV2G_INCLUDE_DIR})
add_dependencies(cbv2g_din cbv2g-src)

add_library(cbv2g_iso2 STATIC IMPORTED)
add_library(cbv2g::iso2 ALIAS cbv2g_iso2)
set_property(TARGET cbv2g_iso2 PROPERTY IMPORTED_LOCATION ${CBV2G_LIB_DIR}/libcbv2g_iso2.a)
set_property(TARGET cbv2g_iso2 PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CBV2G_INCLUDE_DIR})
add_dependencies(cbv2g_iso2 cbv2g-src)
