...
// Copies what energy management currently grants onto the DIN charge-loop values. No defaults:
// negative values clamp to 0 and unreported ones stay 0, so the EV is never told it may draw
