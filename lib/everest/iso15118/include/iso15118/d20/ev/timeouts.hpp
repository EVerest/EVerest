...
// SDP request resend interval (SDP_request_cycle_delay).
constexpr uint32_t SDP_RESEND_INTERVAL_MS = 250;

// Maximum number of SDP requests the EVCC sends before giving up (SDP_max_request) [V2G2-161, V2G-DC-849].
// Bounds retransmissions independently of the overall communication-setup timeout (20 s / 250 ms = 80).
