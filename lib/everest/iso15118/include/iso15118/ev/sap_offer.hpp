...
// Builds the SAP offer: one entry per supported protocol in priority order, DIN skipped under TLS,
// schema_id == priority, numbered from 1. Empty when nothing can be offered.
