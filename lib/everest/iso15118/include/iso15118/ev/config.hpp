...
struct EvConfig {
    ...
    // Bound on the ISO 15118-20 authorization loop, which re-sends while the EVSE reports Ongoing
    // and after a declined attempt. Zero: the ONGOING_AUTHORIZATION table value.
