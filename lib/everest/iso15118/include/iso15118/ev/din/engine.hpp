...
// What DIN SPEC 70121 contributes to ev::PreIso20Engine. It supplies the same set ISO 15118-2 does,
// which is the whole point of the template: the engine itself is not duplicated.
struct EngineTraits {
