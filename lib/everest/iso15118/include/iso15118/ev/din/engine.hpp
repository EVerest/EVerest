...
// DIN SPEC 70121 engine: MessageExchange + Context + FSM starting at SessionSetup. Same method set as
...
public:
    ...
    // False when the frame is not an DIN SPEC 70121 payload (type 0x8001) and was dropped [V2G2-086].
