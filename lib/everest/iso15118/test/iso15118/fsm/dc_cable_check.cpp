...
SCENARIO("ISO15118-20 dc cable check state transitions") {
    ...
    GIVEN("Bad Case - Unknown session") {
        fsm::v2::FSM<d20::StateBase> fsm{ctx.create_state<d20::state::DC_CableCheck>()};
        ...
        THEN("Check state transition") {
            ...
            const auto response_message = ctx.get_response<message_20::DC_CableCheckResponse>();
    ...
    GIVEN("Good case - finished") {
        ...
        // Set control event for cable check finished
        state_helper.set_active_control_event(d20::CableCheckFinished{true});
