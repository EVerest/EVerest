...
SCENARIO("ISO15118-20 EV AC_ChargeParameterDiscovery states the advertised totals for a ThreePhase connector") {
    const ev::feedback::Callbacks callbacks{};
    ...
    // [V2G20-1820]: a symmetric EV states the three-phase total on the base element alone, which
    // [V2G20-1817] has the SECC read as the sum, evenly distributed.
