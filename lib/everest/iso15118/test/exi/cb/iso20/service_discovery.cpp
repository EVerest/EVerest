...
SCENARIO("Se/Deserialize service_discovery messages") {
    ...
    GIVEN("Deserialize service_discovery_req") {
        ...
        THEN("It should be decoded successfully") {
            ...
            REQUIRE(variant.get_type() == msg::d20::Type::ServiceDiscoveryReq);

            const auto& msg = variant.get<msg::d20::ServiceDiscoveryRequest>();
    ...
    GIVEN("Serialize service_discovery_res") {
        ...
        res.header = msg::d20::Header{{0x3D, 0x4C, 0xBF, 0x93, 0x37, 0x4E, 0xD8, 0x9B}, 1725456322};
        res.response_code = msg::d20::datatypes::ResponseCode::OK;
        res.service_renegotiation_supported = false;
        res.energy_transfer_service_list = {{msg::d20::datatypes::ServiceCategory::DC, false},
                                            {msg::d20::datatypes::ServiceCategory::DC_BPT, false}};
    ...
    GIVEN("Serialize service_discovery_res_with_vas_list") {
        ...
        res.energy_transfer_service_list = {{msg::d20::datatypes::ServiceCategory::DC, false},
                                            {msg::d20::datatypes::ServiceCategory::DC_BPT, false}};
        res.vas_list = {{msg::d20::to_underlying_value(msg::d20::datatypes::ServiceCategory::Internet), true}};
    ...
    GIVEN("Deserialize service_discovery_res") {
        ...
        THEN("It should be decoded successfully") {
            ...
            REQUIRE(variant.get_type() == msg::d20::Type::ServiceDiscoveryRes);

            const auto& msg = variant.get<msg::d20::ServiceDiscoveryResponse>();
            const auto& header = msg.header;
            ...
            REQUIRE(msg.energy_transfer_service_list[0].service_id == msg::d20::datatypes::ServiceCategory::DC);
            REQUIRE(msg.energy_transfer_service_list[0].free_service == false);
            REQUIRE(msg.energy_transfer_service_list[1].service_id == msg::d20::datatypes::ServiceCategory::DC_BPT);
    ...
    GIVEN("Deserialize service_discovery_res_with_vas_list") {
        ...
        THEN("It should be decoded successfully") {
            ...
            REQUIRE(msg.vas_list.value()[0].service_id ==
                    msg::d20::to_underlying_value(msg::d20::datatypes::ServiceCategory::Internet));
