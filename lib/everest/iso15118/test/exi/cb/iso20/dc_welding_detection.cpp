...
SCENARIO("Se/Deserialize dc welding detection messages") {
    ...
    GIVEN("Deserialize dc welding detection req") {
        ...
        THEN("It should be deserialized successfully") {
            REQUIRE(variant.get_type() == msg::d20::Type::DC_WeldingDetectionReq);

            const auto& msg = variant.get<msg::d20::DC_WeldingDetectionRequest>();
    ...
    GIVEN("Serialize dc welding detection req") {
        ...
        msg::d20::DC_WeldingDetectionRequest req;

        req.header = msg::d20::Header{{0x3D, 0x4C, 0xBF, 0x93, 0x37, 0x4E, 0xD8, 0x9B}, 1725456341};
    ...
    GIVEN("Serialize dc_welding_detection res") {
        ...
        res.header = msg::d20::Header{{0x3D, 0x4C, 0xBF, 0x93, 0x37, 0x4E, 0xD8, 0x9B}, 1725456341};
    ...
    GIVEN("Deserialize dc welding detection res") {
        ...
        THEN("It should be deserialized successfully") {
            REQUIRE(variant.get_type() == msg::d20::Type::DC_WeldingDetectionRes);

            const auto& msg = variant.get<msg::d20::DC_WeldingDetectionResponse>();
            const auto& header = msg.header;
