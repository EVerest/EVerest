...
void DinEvEngine::on_packet(io::v2gtp::PayloadType payload_type, const io::StreamInputView& view) {
    // DIN SPEC 70121 rides on the same V2GTP payload type as ISO 15118-2 (SAP, 0x8001); anything
    // else is a frame this stack does not support and is ignored rather than decoded (see the
    // ISO 15118-2 EV engine for the reasoning).
