...
static void convert(const struct iso2_DC_EVPowerDeliveryParameterType& in,
                    datatypes::DC_EVPowerDeliveryParameter& out) {
...
static void convert(const datatypes::DC_EVPowerDeliveryParameter& in,
                    struct iso2_DC_EVPowerDeliveryParameterType& out) {
