...
Result ServiceDiscovery::feed(Event ev) {
    ...
    // enforce_contract selects Contract regardless of the offer ([V2G2-465] robustness test).
    ...
    if (not result.mode_supported) {
        ...
        // with FAILED_WrongEnergyTransferMode [V2G2-476], which surfaces the mismatch.
