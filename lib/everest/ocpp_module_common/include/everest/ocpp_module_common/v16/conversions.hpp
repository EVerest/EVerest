...
/// \brief Converts a given types::system::BootReason \p reason to a ocpp::v16::BootReasonEnum.
...
/// \brief Converts a given types::display_message::DisplayMessageStatusEnum \p display_message_status_enum to a
...
/// \brief Converts a given types::display_message::SetDisplayMessageResponse \p set_display_message_response to a
