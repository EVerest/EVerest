...
struct CertificateSigningRequestInfo {
    ...
    /// @brief subject domainComponent (DC), omitted when unset
    std::optional<std::string> domain_component;

    /// @brief request keyUsage keyAgreement in addition to digitalSignature
