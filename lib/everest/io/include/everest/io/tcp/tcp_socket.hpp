...
/**
 * @var SourcePortRange
 * @brief Inclusive range of local source ports, see \ref socket::SourcePortRange
 */
using SourcePortRange = socket::SourcePortRange;
...
private:
    ...
    std::string m_device;
    std::optional<SourcePortRange> m_source_ports{};
