...
// TUNSETCARRIER entered the UAPI with Linux 5.0. Sysroots with older kernel headers (the armv7
// cross toolchains, for one) do not declare it; the ioctl number is ABI-stable, and a kernel that
// does not implement it answers EINVAL, which set_carrier() reports through carrier_setup_error().
