...
using payload_t = fd_event_client<tls_client_socket>::payload;
using tls_interface = typename tls_client::interface;
...
int main(int argc, char* argv[]) {
    ...
    client.set_rx_handler([&replies_received, &running, expected_replies](payload_t const& payload, tls_interface&) {
        ++replies_received;
