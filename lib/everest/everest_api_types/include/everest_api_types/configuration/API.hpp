...
enum class ConfigurationParameterGetRequestEnum {
    OK,
    DoesNotExist,
};
...
struct GetConfigurationParameterRequest {
    int32_t slot_id;
    std::vector<ConfigurationParameterIdentifier> parameters;
    std::optional<bool> force_read_from_db;
};

struct ConfigurationParameterGetValueResult {
    ConfigurationParameterGetRequestEnum status;
    std::optional<ConfigurationParameter> parameter;
};

struct GetConfigurationParameterResult {
    GetConfigurationStatusEnum status;
    std::optional<std::vector<ConfigurationParameterGetValueResult>> parameter_values;
};
