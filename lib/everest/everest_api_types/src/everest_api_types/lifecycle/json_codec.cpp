...
void to_json(json& j, ExecutionStatusUpdateNotice const& k) noexcept {
    j = json{{"tstamp", k.tstamp},
             {"everest_running", k.everest_running},
             {"module_status", k.module_status},
             {"configuration_api_available", k.configuration_api_available},
             {"lifecycle_api_ro", k.lifecycle_api_ro}};
}
