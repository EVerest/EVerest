...
using ClearSessionsRequest_Internal = ::types::session_storage::ClearSessionsRequest;
using ClearSessionsRequest_External = ClearSessionsRequest;

ClearSessionsRequest_Internal to_internal_api(ClearSessionsRequest_External const& val);
ClearSessionsRequest_External to_external_api(ClearSessionsRequest_Internal const& val);
